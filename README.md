...
> 记录嵌入式、计算机视觉和机器人开发中的实践与思考。

基于 [Astro](https://astro.build) 构建的个人博客，主题由 [Gyoza](https://github.com/lxchapu/astro-gyoza) 定制而来。
...
- **CSS 动画**：弹性入场、交错淡入、卡片悬浮等微交互，支持减少动画偏好
- **响应式设计**：完美适配桌面、平板和移动设备
- **暗色/亮色主题**：支持系统主题跟随与手动切换
- **内容友好**：Markdown 写作，代码高亮，数学公式渲染
- **渐进增强**：Islands 架构，保持核心内容可访问性
- **页面过渡**：ViewTransitions 平滑切换
- **搜索功能**：全站内容搜索
...
│   ├── layouts/       # 布局组件
│   ├── pages/         # 页面路由
│   ├── styles/        # 全局样式（含动画库 animations.css）
│   └── utils/         # 工具函数
